	...
	public void checkCollision(){
		...
		for (Bee value : bee) {
			...
			if (bulletRect.intersects(beeRect)) {
				...
				value.setImagePath("src//resources//images//BeeBlast//blast1.png"); //When bullet hits a bee, it shows a blast
				try {
					Thread.sleep(100);
				} catch (Exception e) {
					//exception handling
				...
				value.setImagePath("src//resources//images//Bee//Bee1.png"); //After Blast setting the image again
